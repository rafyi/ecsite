...
//	WebサービスApiとして作成する為JSON形式を扱えるようGsonをインスタンス化
//	Gsonは最初の方にbuildでdependenciesに入れたやつ
	...
	public String loginApi(@RequestBody LoginForm form) {
		 ...
		 * その後DTOをゲストの情報で初期化し、検索結果が存在していた場合のみ
		 * 実在のユーザ情報をDTOに詰める 
		 * 最終的にDTOをJSONオブジェクトとして画面に返す */
	}
	@ResponseBody
